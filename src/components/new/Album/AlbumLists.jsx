              ...
              <div className="release_tabs_wrapper" key={language.id}>
                <ul className="nav nav-tabs">
                  <li className="nav-item">
                    <div className="nav-link" data-toggle="tab" onClick={() => handleClick(language.id)}>
                      {language.name}
                    </div>
                  </li>
                </ul>
                ...
                <div className="row">
                  ...
                  {songs.length > 0 ? (
                    songs.map((song) => (
                      ...
                      // <Album key={song.song_id} id={song.song_id} imgPath={song.song.img_path} songName={song.song.name} songPath={song.song.songPath} />

                      <div key={song.id} className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 pd1">
                        <div className="treanding_slider_main_box release_box_main_content m24_cover">
                          <Image src={song.song.img_path} height={400} width={400} alt="img"/>
                          <div className="release_content_artist release_content_artist2">
                            <p>
                              <a href="#">{song.song.name}</a>
                            </p>
...
// const Album = ({ id, songName, imgPath, songPath }) => {
