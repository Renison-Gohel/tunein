...
// import ReactHowler from '../../../../node_modules/react-howler'
import raf from 'raf' // requestAnimationFrame polyfill

function Player() {
    return (
        <div className="adonis-player-wrap index3_adoins_wrapper" tabIndex={9}>
            <div
            ...
            >
                ...
                <div id="adonis-playlist" className="adonis-playlist off-canvas off-canvas-right">
                    <div className="adonis-playlist-player adonis-player player-bg-yellow">
                        ...
                        <div className="media current-item">
                            ...
                            <div className="player-details col-8">
                                <h3 className="jp-title">Renison - 3 </h3>
