...
export default async function Home() {
  ...
  <Preloader /> */}
      ...
      <Suspense fallback={<>Loading...</>}>
        ...
        <div className="m24_main_wrapper">
              ...
              <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12">
                  <div className="add_banner_img_wrapper m24_cover">
                    <a href="#">
                      <img src="images/add2.png" className="img-responsive" alt="img" />
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div className="concert_wrapper m24_cover">
            ...
            <div className="concert_video_wrapper">
              <a className="test-popup-link button" rel="external" href="https://www.youtube.com/embed/ryzOXAO0Ss0"
                title="title">
              ...
              <div className="row">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                  <div className="download_mockup_design m24_cover">
                    <img src="images/mockup.png" className="img-responsive" alt="img" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12">
                  <div className="add_banner_img_wrapper m24_cover">
                    <a href="#">
                      <img src="images/add7.png" className="img-responsive" alt="img" />
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                  <div className="featured_artist_list blog_img_content index3_blog_img_content m24_cover">
                    <img src="images/blog1.png" className="img-responsive" alt="img" />
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                  <div className="featured_artist_list blog_img_content index3_blog_img_content m24_cover">
                    <img src="images/blog2.png" className="img-responsive" alt="img" />
                    <div className="featured_artist_detail blog_content_box">
                      <span>
                        {" "}
                        <i className="flaticon-calendar" />3 May, 2019
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                  <div className="featured_artist_list blog_img_content index3_blog_img_content m24_cover">
                    <img src="images/blog3.png" className="img-responsive" alt="img" />
                    <div className="featured_artist_detail blog_content_box">
                      <span>
                        {" "}
                        <i className="flaticon-calendar" />3 May, 2019
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                  <div className="featured_artist_list blog_img_content index3_blog_img_content m24_cover">
                    <img src="images/blog4.png" className="img-responsive" alt="img" />
                    <div className="featured_artist_detail blog_content_box">
                      <span>
                        {" "}
                        <i className="flaticon-calendar" />3 May, 2019
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12">
                  <div className="add_banner_img_wrapper m24_cover">
                    <a href="#">
                      <img src="images/add1.png" className="img-responsive" alt="img" />
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-lg-3 col-md-6 col-12 col-sm-12">
                  <div className="footer_widget footer_about_wrapper m24_cover">
                    <div className="wrapper_first_image">
                      <a href="index.html">
                        <img src="images/logo3.png" className="img-responsive" alt="logo" />
                      </a>
                    </div>
                ...
                <div className="col-lg-3 col-md-6 col-12 col-sm-12">
                  <div className="footer_widget footer_contact_wrapper ft_heading m24_cover">
                    ...
                    <span>
                      <a href="#">
                        <img src="images/app_btn1.png" className="img-responsive" alt="img" />
                      </a>
                    </span>
                    <span>
                      <a href="#">
                        <img src="images/app_btn2.png" className="img-responsive" alt="img" />
                      </a>
                    </span>
                    <span>
                      <a href="#">
                        <img src="images/app_btn3.png" className="img-responsive" alt="img" />
                      </a>
                    </span>
                  </div>
                </div>
        ...
        <div className="modal fade lang_m24_banner index3_lang_wrapper" id="myModal" role="dialog">
        ...
        <div className="modal fade lang_m24_banner index3_login_modal" id="login_modal" role="dialog">
          <div className="modal-dialog">
            <div className="modal-content">
              <button type="button" className="close" data-dismiss="modal">
                ×
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                  ...
                  <div className="login_form_wrapper">
                    <div className="icon_form comments_form">
                      <input type="text" className="form-control" name="full_name" placeholder="Enter Email Address*" />
        ...
        <div className="modal fade lang_m24_banner index3_login_modal" id="register_modal" role="dialog">
          <div className="modal-dialog">
            <div className="modal-content">
              <button type="button" className="close" data-dismiss="modal">
                ×
              ...
              <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                  ...
                  <div className="login_form_wrapper">
                    <div className="icon_form comments_form">
                      <input type="text" className="form-control" name="first_name" placeholder="Enter your name" />
